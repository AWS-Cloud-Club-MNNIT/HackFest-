...
const OverviewTab = ({ setActiveMenu }) => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Quick Actions */}
      <div className="parchment-card relative overflow-hidden rounded-2xl border border-[#d4af37]/30 bg-[#101522]/80 p-8 shadow-xl">
        <h3 className="mb-6 text-2xl font-harry tracking-wide text-[#f4e8c1] drop-shadow-[0_2px_10px_rgba(212,175,55,0.2)]">
          Quick Actions
        </h3>
