...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-[#080b16] text-[#e8d7b5] flex items-center justify-center px-4 relative overflow-hidden animate-magic-reveal">
      ...
      <button 
        onClick={() => navigate("/")}
        className="absolute top-6 left-4 sm:left-8 z-20 flex items-center gap-2 text-[#d4af37] hover:text-[#f4e8c1] transition-colors font-serif bg-[#080b16]/60 px-4 py-2 rounded-full border border-[#d4af37]/30 hover:border-[#d4af37]/80 backdrop-blur-md hover:shadow-[0_0_15px_rgba(212,175,55,0.2)]"
      >
