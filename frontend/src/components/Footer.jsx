        ...
        <div className="grid gap-12 lg:grid-cols-12 lg:gap-8">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <a 
                href="https://www.google.com/maps/search/?api=1&query=MNNIT+Allahabad"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-5 inline-flex items-center gap-2.5 rounded-full border border-[#d4af37]/40 bg-[#10182b]/80 px-4 py-1.5 text-xs text-[#f4e8c1] hover:bg-[#d4af37]/10 hover:border-[#d4af37] hover:shadow-[0_0_15px_rgba(212,175,55,0.2)] transition-all cursor-pointer group"
              >
                <svg className="h-4 w-4 text-[#d4af37] group-hover:scale-110 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
